...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO financeiro (tipo, descricao, valor, data)
...
<head>
    ...
    <title>Adicionar Registro Financeiro</title>
    <style>
        :root {
        ...
        <div class="form-container">
            <?php if (isset($success) && $success) { ?>
                <div class="alert alert-success">
                    <span>✅</span>
                    <span>Registro financeiro adicionado com sucesso!</span>
                </div>
                <div class="btn-group">
                    <a href="financeiro.php" class="btn btn-primary">
                        <span>📊</span> Voltar ao Painel
                    </a>
                    <a href="adicionar_financa.php" class="btn btn-secondary">
